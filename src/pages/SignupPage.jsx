    ...
    <div className="min-h-screen text-[#252422] bg-[#f5f5f5] px-4 md:px-12">
      ...
      <form className="mt-10 max-w-xl mx-auto justify-center items-center">
        <div className="flex flex-col w-full space-y-5">
          ...
          <div className="space-y-5">
            <label className="md:text-lg">Confrm Password :</label>
            <input
              type="password"
              placeholder="Re-enter your password"
              className="mb-10 w-full px-3 py-1.5 
              md:py-2 text-[#252422] rounded-lg bg-white border border-gray-500"
            />
          </div>
        </div>
        <button className="mb-5 w-full bg-[#403D39] text-[#FFFCF2] py-2 font-medium rounded-lg">Submit</button>
        <p className="text-center">Already have an account? 
          <Link to={"/login"} className="text-[#944424]"> Log in</Link></p>
      </form>
    </div>
  )
}
